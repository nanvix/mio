...
#[cfg(not(any(target_os = "aix", target_os = "illumos", target_os = "solaris", target_os = "vita", target_os = "nanvix")))]
...
#[cfg(any(target_os = "aix", target_os = "illumos", target_os = "solaris", target_os = "vita", target_os = "nanvix"))]
fn set_nonblocking(fd: RawFd, nonblocking: bool) -> io::Result<()> {
